...
<div>
  ...
  <svg width="350" height="350">
    <cell v-for="(s,id) in status" v-on:toggle="pushed($event)" v-bind:key=id :idx=s.idx v-bind:x=s.x v-bind:y=s.y v-bind:v=s.v></cell>
  </svg>
...
<script>
import cell from '~/components/cell.ve'
